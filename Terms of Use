...
Please read these Terms and Conditions carefully before using the **Hashtag Genius for Instagram** mobile application operated by Shakd, LLC.
...
Hashtag Genius for Instagram has no control over, and assumes no responsibility for the content, privacy policies, or practices of any third party web sites or services. We do not warrant the offerings of any of these entities/individuals or their websites.
